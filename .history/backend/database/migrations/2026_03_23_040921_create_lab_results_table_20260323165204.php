...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('lab_results', function (Blueprint $table) {
            ...
            $table->foreignId('lab_test_definition_id')
                ->nullable()
                ->constrained('lab_test_definitions')
                ->nullOnDelete();
            ...
            $table->string('reference_source', 20)->default('manual'); // manual / default_definition

            $table->string('flag', 20)->default('unknown');
            $table->decimal('ai_confidence', 5, 4)->nullable();

            $table->decimal('price', 12, 2)->default(0);
            $table->boolean('include_in_billing')->default(true);
            ...
            $table->index(['lab_test_definition_id']);
